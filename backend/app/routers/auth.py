...
from app.schemas import LoginRequest, TokenDataResponse, TokenResponse, UserDataResponse, UserOut
...
async def login(
    credentials: LoginRequest, uow: AbstractUnitOfWork = Depends(get_uow)
) -> TokenDataResponse:
    try:
